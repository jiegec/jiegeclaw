...
// Import channel registrations to populate the registry
import "./channels/weixin-register.js";
import "./channels/feishu-register.js";
import "./channels/wecom-register.js";
